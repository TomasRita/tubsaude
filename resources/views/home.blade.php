...
@section('content')
        ...
        <div class="hero-luz">
          <img class="luz" src="./assets/formas/Luz.png" alt="">
        </div>

        <section class="welcome" id="welcome">

            <div class="design">
                <img class="seta2" src="./assets/formas/seta 2.png" alt="">
               
                <img src="./assets/formas/Design.png" alt="">
            </div>
            <div class="hero">
                <div class="conteudo">
                    <div class="logo">
                        <svg width="400" height="400" viewBox="0 0 544 152" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M56.352 38.32V53.296H38.304V106H19.488V53.296H1.632V38.32H56.352ZM118.418 52.144V106H99.5055V98.32C97.9055 100.752 95.6975 102.736 92.8815 104.272C90.0655 105.744 86.8335 106.48 83.1855 106.48C76.9135 106.48 71.9535 104.432 68.3055 100.336C64.7215 96.176 62.9295 90.544 62.9295 83.44V52.144H81.6495V81.04C81.6495 84.112 82.4495 86.544 84.0495 88.336C85.7135 90.064 87.8895 90.928 90.5775 90.928C93.3295 90.928 95.5055 90.064 97.1055 88.336C98.7055 86.544 99.5055 84.112 99.5055 81.04V52.144H118.418ZM147.942 59.632C149.414 57.072 151.494 55.088 154.182 53.68C156.87 52.208 160.038 51.472 163.686 51.472C167.974 51.472 171.846 52.592 175.302 54.832C178.822 57.072 181.574 60.272 183.558 64.432C185.606 68.592 186.63 73.456 186.63 79.024C186.63 84.592 185.606 89.488 183.558 93.712C181.574 97.872 178.822 101.072 175.302 103.312C171.846 105.552 167.974 106.672 163.686 106.672C160.038 106.672 156.87 105.968 154.182 104.56C151.494 103.088 149.414 101.072 147.942 98.512V106H129.126V34.96H147.942V59.632ZM167.526 79.024C167.526 75.504 166.566 72.784 164.646 70.864C162.79 68.88 160.486 67.888 157.734 67.888C154.982 67.888 152.646 68.88 150.726 70.864C148.87 72.848 147.942 75.568 147.942 79.024C147.942 82.544 148.87 85.296 150.726 87.28C152.646 89.264 154.982 90.256 157.734 90.256C160.486 90.256 162.79 89.264 164.646 87.28C166.566 85.232 167.526 82.48 167.526 79.024Z" fill="#343434"/>
                    ...
                    <p>
                        Bem-vindo ao nosso portal de marcação de consultas! Aqui, buscamos simplificar o processo de agendamento de consultas médicas, proporcionando uma experiência conveniente e eficiente para nossos pacientes.
                    </p>
                </div>
               <div class="button auth-user" id="userhomeButton" style="display:none">
                  <a id="registercreatBtn" href="{{ route('MarcarConsulta') }}">Marcar Consulta</a>
               </div>
              <div class="button auth-register" id="registerhomeButton">
                 <a id="registercreatBtn" href="#">Registra-se</a>
              </div>
            </div>
            <div class="img">
                <img src="./assets/formas/fotod 1.png" alt="">
            </div>

            <section class="service" id="service">
           <h1>Serviços</h1>
           <div class="line-1">
            <img src="./assets/formas/lne-1.png" alt="">
           </div>
           <div class="conteudo">
            <p>Oferecemos uma ampla gama de serviços 
            médicos para atender às suas necessidades de
            saúde. Nossos especialistas estão disponíveis para consultas em diversas áreas, incluindo:</p>
            <ul id="specialties-list">
                <!-- Espaço reservado para especialidades (será preenchido pelo JavaScript) -->
            </ul>
           </div>
           <div class="line-2">
            <img src="./assets/formas/lne-2.png" alt="">
           </div>
         </section>
         ...
         <section class="about" id="about">
           <div class="img">
              <img src="./assets/formas/Photo.png" alt="">
           </div>
           <div class="conteudo">
                <h1>Sobre Nós</h1>
                <p>Somos uma equipe dedicada de profissionais de
                    saúde comprometidos em fornecer cuidados de 
                    alta qualidade aos nossos pacientes. Nossa 
                    missão é tornar o processo de agendamento de 
                    consultas tão simples e acessível quanto 
                    possível, visando promover o bem-estar e a 
                    saúde de nossa comunidade</p>
           </div>
           <div class="seta">
             <img src="./assets/formas/lne.png" alt="">
           </div>
        </section>
        ...
        <section class="contact" id="contact">
             ...
             <form>
                <h1>Fala Connosco</h1>
                <div class="input">
                    <input type="email" id="Send_Email_Contact" name="email" placeholder="Insira seu email" required>
                    <i class="fas fa-user"></i>
                </div>
                <div class="input">
                   <textarea name="sms" id="id_sms" cols="30" rows="10" placeholder="Degite a sua mensagem...."></textarea>
                </div>
